...
var _brotliFsize = _interopRequireDefault(require("brotli-fsize"));
...
class Module extends _Node.default {
  ...
  get brotliSize() {
    if (!_lodash.default.has(this, '_brotliSize')) {
      this._brotliSize = this.src ? _brotliFsize.default.sync(this.src) : undefined;
    }
